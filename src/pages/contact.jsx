        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-[#6B6B6B] text-base sm:text-lg mb-8 leading-relaxed">
              ...
              and creative needs! Whether you are looking for Paintings,
              Handmade Jewelry, Home Decor, Traditional Crafts, Sculptures, or
              Textiles, we are here to assist you.
            </p>
          ...
          <div className="flex justify-center md:justify-end">
            <div className="w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full overflow-hidden bg-white shadow-lg">
              ...
              <img
                src="/about/contact us iamge.png"
                alt="Artisan working"
