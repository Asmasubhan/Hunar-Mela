          ...
          <div>
            ...
            <div className="mb-10">
              ...
              <p className="text-[#6B6B6B] leading-relaxed">
                ...
                creativity and craftsmanship. We bring together Paintings,
                Handmade Jewelry, Home Decor, Traditional Crafts, Sculptures,
                and Textiles, supporting artisans and promoting unique,
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-[#6B6B6B]">
                      {" "}
                      – Always exploring new designs and ideas.
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-[#6B6B6B]">
                      {" "}
                      – Supporting artisans and customers alike.
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-[#6B6B6B]">
                      {" "}
                      – Encouraging originality in every product we offer.
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#F5F5F5] rounded-xl p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-lg p-5">
                  <p className="text-[#6B6B6B] text-sm mb-2">
                    <span className="text-xl text-[#F97316]">"</span>
                    Hunar Mela's platform gave my handmade products the exposure
                    they deserved.
                    <span className="text-xl text-[#F97316]">"</span>
                  </p>
